...
### 6. Expanded Model Selection

The list of available models for experiments has been significantly expanded. You can now choose from a wider selection of models, including new additions from Google, Mistralai, X-AI, and Meta-Llama. This allows for more tailored and potentially more effective solutions to your specific needs.

<Frame>
  <img
    src="/images/experiments/model-selection.webp"
    alt="Select from a wide range of models including new additions from Google, Mistralai, X-AI, and Meta-Llama."
  />
</Frame>
