...
The experiment feature now supports a wider range of models from various providers, including Google, Mistralai, X-AI, and Meta-Llama. This expansion allows for greater flexibility and choice in model selection, enhancing the experimentation process.
