...
### 6. Expanded Model Options

The experiment feature now includes a wider range of models from various providers such as Google, Mistralai, X-AI, and Meta-Llama. This expansion allows you to experiment with a broader array of AI capabilities, enhancing the flexibility and scope of your experiments.

<Frame>
  <img
    src="/images/experiments/model-options.webp"
    alt="Explore a wider range of models from different providers in your experiments."
  />
</Frame>

<Note>
  Models with names including "gpt" are associated with the "OPENAI" provider, while others default to "OPENROUTER".
</Note>
