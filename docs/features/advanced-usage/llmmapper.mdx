...
LLMMapper has expanded its model support to include a wider range of models from various providers. This includes new models from Google (Gemini series), Mistralai (Ministral and Mistral series), X-AI (Grok), and Meta-Llama (Llama series). This expansion provides users with more options and flexibility in model selection, enhancing the experimentation capabilities within the platform.
