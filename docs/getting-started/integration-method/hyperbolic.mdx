...
You can seamlessly integrate Helicone with the OpenAI compatible or newly added models from Google, Mistralai, X-AI, and Meta-Llama that are deployed on Hyperbolic.
