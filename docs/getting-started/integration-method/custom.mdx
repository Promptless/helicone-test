...
description: "Integrate any custom LLM, including models from Google, Mistralai, X-AI, and open-source models like Llama and GPT-Neo, with Helicone. Step-by-step guide for both NodeJS and Curl implementations to connect your proprietary or open-source models."
