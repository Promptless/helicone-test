...
description: "Integrate any custom LLM, including open-source models like Llama, GPT-Neo, Mistral, X-AI Grok, Google Gemini, and Meta-Llama, with Helicone. Helicone now also supports the 'OPENROUTER' provider for expanded model integration. Step-by-step guide for both NodeJS and Curl implementations to connect your proprietary or open-source models."
