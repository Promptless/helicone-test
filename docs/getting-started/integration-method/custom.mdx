...
description: "Integrate any custom LLM, including open-source models like Llama, GPT-Neo, Mistralai, X-AI, Meta-Llama, and Google, with Helicone. Step-by-step guide for both NodeJS and Curl implementations to connect your proprietary or open-source models."
