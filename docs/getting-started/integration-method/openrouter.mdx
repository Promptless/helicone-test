...
Now you can access all the models on OpenRouter with a simple fetch call: Additionally, OpenRouter has expanded its selection of advanced LLMs, including Google Gemini, Mistralai, X-AI's Grok, and Meta's Llama. You can specify any of these model names in the "model" parameter of your request body to seamlessly access their capabilities.
