...
Now you can access an expanded selection of models on OpenRouter, including new offerings from Google, Mistralai, X-AI, and Meta-Llama, with a simple fetch call:
