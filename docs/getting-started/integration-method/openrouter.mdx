...
Now you can access all the models on OpenRouter with a simple fetch call: you can also use newly available providers from Google, Mistralai, X-AI, and Meta-Llama, giving you expanded options beyond OpenAI and Anthropic.
