...
OpenRouter now supports additional model providers including Google, Mistralai, X-AI, and Meta-Llama. This expansion allows for greater flexibility and experimentation with a diverse set of models.

<Info>
  **Note:** Ensure that any specific configurations or limitations related to these new models are reviewed in the OpenRouter documentation.
</Info>
