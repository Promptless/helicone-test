...
<Accordion title="Mistralai example">
```bash
curl --request POST \
  --url https://gateway.helicone.ai/v1/chat/completions \
  --header 'Authorization: Bearer <MISTRALAI_API_KEY>' \
  --header 'Content-Type: application/json' \
  --header 'Helicone-Auth: Bearer <HELICONE_API_KEY>' \
  --header 'Helicone-Target-Provider: Mistralai' \
  --header 'Helicone-Target-Url: https://api.mistral.ai' \
  --data '{
...
<Accordion title="X-AI example">
```bash
curl --request POST \
  --url https://gateway.helicone.ai/v1/chat/completions \
  --header 'Authorization: Bearer <X_AI_API_KEY>' \
  --header 'Content-Type: application/json' \
  --header 'Helicone-Auth: Bearer <HELICONE_API_KEY>' \
  --header 'Helicone-Target-Provider: X-AI' \
  --header 'Helicone-Target-Url: https://api.x.ai' \
  --data '{
  "model": "xai-model-1",
  "messages": [
    {
