...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="diagram-next"
  >
    Utilize any provider through a single endpoint, including newly added Gemini, Mistralai, Grok from X-AI, and Meta's Llama models for more varied experimentation.
  </Card>
  <Card
    title="Retries"
