...
<Steps>
  ...
  <Step title="Configure your experiment">
    Select the dataset, model and provider keys. The available models now include new options from Google (Gemini series), Mistralai (Ministral and Mistral series), X-AI (Grok), and Meta-Llama (Llama series).
    <Tip>
