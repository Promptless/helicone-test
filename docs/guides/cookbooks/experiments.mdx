...
<Steps>
  ...
  <Step title="Configure your experiment">
    Select the dataset, model and provider keys. Helicone now includes new models from Google, Mistralai, X-AI, and Meta-Llama, giving you more options to find the right fit for your use case.
    <Tip>
