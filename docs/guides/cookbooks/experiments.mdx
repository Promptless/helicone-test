...
<Steps>
  ...
  <Step title="Configure your experiment">
    Select the dataset, model and provider keys. The expanded list of supported models now includes options from Google (Gemini series), Mistralai (Ministral and Mistral series), X-AI (Grok), and Meta-Llama (Llama series).
    <Tip>
