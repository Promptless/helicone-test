...
<Steps>
  ...
  <Step title="Configure your experiment">
    Select the dataset, model and provider keys. Helicone now supports the 'OPENROUTER' provider and new models such as 'gemini-flash-1.5', 'mistral-7b-instruct', 'grok-beta', and 'llama-3.2-3b-instruct'.
    <Tip>
