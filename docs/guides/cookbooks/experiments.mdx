...
<Steps>
  ...
  <Step title="Configure your experiment">
    ...
    <Tip>
      Helicone supports a broad selection of AI models, including Gemini (Google), Mistralai, Grok (X-AI), Meta's Llama, and OpenAI's GPT-based models, giving you the flexibility to run diverse experiments.
    </Tip>
    <Tip>
