...
<Steps>
  ...
  <Step title="Configure your experiment">
    Select the dataset, model and provider keys. Helicone supports a broad range of models from providers including Google, Mistralai, X-AI, and Meta-Llama, in addition to GPT-based models from OpenAI. If you choose a GPT-based model, Helicone will automatically associate it with the OpenAI provider, while other models are typically served through OpenRouter.
    <Tip>
