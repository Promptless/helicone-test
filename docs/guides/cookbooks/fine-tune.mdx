...
<Steps>
  ...
  <Step title="Configure Your Fine-Tuning Job">
    ...
    Helicone and OpenPipe now support a broader set of models, including new providers such as Google (gemini-flash-1.5), Mistralai (mistral-7b-instruct), X-AI (grok-beta), and Meta-Llama (llama-3.2-3b-instruct). Explore these options to find the best fit for your specific use case.
