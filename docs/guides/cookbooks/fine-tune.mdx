...
<Steps>
  ...
  <Step title="Configure Your Fine-Tuning Job">
    ...
    - **Model Selection**: Choose the base model you wish to fine-tune. Helicone and OpenPipe now support a broader range of LLMs from providers like Google, Mistralai, X-AI, and Meta-Llama in addition to GPT-based models.
